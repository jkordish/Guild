...
- `examples/runtime-invoke-skill-multi-child.contract.json`
- `examples/runtime-invoke-skill-multi-child.admit.request.json`
- `examples/runtime-invoke-skill-multi-child.invocation.json`
