...
- `0021-adopt-the-effect-kernel-as-guilds-mutation-truth-boundary.md` - accepted adoption of the pure effect kernel as Guild's exact external-mutation, receipt, custody, and non-repeating recovery boundary
