...
- Guild skill identity follows manifest version plus resolved artifact identity rather than implementation-language package metadata such as Cargo package versions
