...
- Benchmark evidence:
  ...
  - `benchmark_matrix.json.slices[emit-evidence-single-emission-exact-local-object-store]`
...
- Validating tests:
  ...
  - `crates/guild-runner/tests/live_proofs.rs::emit_evidence_live_proof_supports_one_exact_single_sink_slice`
...
- Scenario and example anchors:
  - `crates/guild-runner/examples/live_proof_scenarios.rs` scenarios `read-resource-bounded`, `http-request-bounded`, `http-request-default-port-bounded`, `http-request-localhost-bounded`, `http-request-localhost-default-port-bounded`, `http-request-localhost-head-bounded`, `http-request-localhost-head-default-port-bounded`, `http-request-head-bounded`, `http-request-head-default-port-bounded`, `invoke-skill-single-child-bounded`, `invoke-skill-multi-child-bounded`, `emit-evidence-exact-single-sink`, `http-request-redirect-unsupported`, `emit-evidence-single-sink-replay-unavailable`
- Codepaths:
...
- Support-matrix evidence:
  ...
  - `family_support_matrix.json.families.emit-evidence.proven_slices[exact-single-emission-fixed-local-object-store]`
...
- Support-matrix evidence:
  ...
  - `family_support_matrix.json.families.invoke-skill.proven_slices[two-child-same-alias-zero-authority-inspect-fan-out]`
  - `family_support_matrix.json.families.emit-evidence.proven_slices[exact-single-emission-fixed-local-object-store]`
  - `family_support_matrix.json.families.emit-evidence.not_proven_shapes[broader-or-legacy-single-emission-local-object-store]`
- Validating tests:
