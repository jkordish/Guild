...
fn slice_specs() -> Vec<SliceSpec> {
    vec![
        ...
        SliceSpec {
            slice_id: "http-request-localhost-get-default-port",
            family: "http-request",
            slice_name: "localhost GET default port",
            exact_scope: "GET http://localhost/response.json with deterministic loopback-only resolution binding",
            support_status: "supported",
            scenario_name: "http-request-localhost-default-port-bounded",
            contract: "examples/runtime-http-localhost-default-port.contract.json",
            request: "examples/runtime-http-localhost-default-port.admit.request.json",
            invocation: "examples/runtime-http-localhost-default-port.invocation.json",
            execution_record_path: Some(
                "examples/runtime-http-localhost-default-port.execution-record.json",
            ),
            linked_path: LinkedPath::ProofLinked,
            default_path: "proof_backed",
            token_linkage_status: "proof_backed",
            ...
            negative_claim_support_status: "supported",
            negative_claim_type: Some("no_http_request_outside_scope"),
            notes: "Bounded proof-backed localhost GET slice with the implicit default HTTP port and deterministic resolution binding.",
        },
        SliceSpec {
        ...
        SliceSpec {
            slice_id: "http-request-localhost-head-default-port",
            family: "http-request",
            slice_name: "localhost HEAD default port",
            exact_scope: "HEAD http://localhost/response.json with deterministic loopback-only resolution binding",
            support_status: "supported",
            scenario_name: "http-request-localhost-head-default-port-bounded",
            contract: "examples/runtime-http-localhost-head-default-port.contract.json",
            request: "examples/runtime-http-localhost-head-default-port.admit.request.json",
            invocation: "examples/runtime-http-localhost-head-default-port.invocation.json",
            execution_record_path: Some(
                "examples/runtime-http-localhost-head-default-port.execution-record.json",
            ),
            linked_path: LinkedPath::ProofLinked,
            default_path: "proof_backed",
            token_linkage_status: "proof_backed",
            ...
            negative_claim_support_status: "supported",
            negative_claim_type: Some("no_http_request_outside_scope"),
            notes: "Bounded proof-backed localhost HEAD slice with the implicit default HTTP port and deterministic resolution binding.",
        },
        SliceSpec {
...
impl SliceSpec {
    ...
    fn resource_binding(self) -> Option<Value> {
        match self.slice_id {
            ...
            "http-request-localhost-get-default-port" => Some(json!({
                "family": "http-request",
                "resource": "GET:http://localhost/response.json",
            })),
            "http-request-localhost-head-explicit-port" => Some(json!({
                "family": "http-request",
                "resource": "HEAD:http://localhost:18080/response.json",
            })),
            "http-request-localhost-head-default-port" => Some(json!({
                "family": "http-request",
                "resource": "HEAD:http://localhost/response.json",
            })),
