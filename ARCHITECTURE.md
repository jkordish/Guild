...
- supported proof-linked slices only for `read-resource`, the eight bounded `http-request` replay slices, and the two bounded `invoke-skill` zero-authority inspect slices
